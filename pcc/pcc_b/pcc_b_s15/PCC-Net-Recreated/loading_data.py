...
def loading_data():
    ...
    train_loader = DataLoader(train_set, batch_size=cfg.TRAIN.BATCH_SIZE, num_workers=0, shuffle=True, drop_last=True)
    ...
    val_loader = DataLoader(val_set, batch_size=cfg.VAL.BATCH_SIZE, num_workers=0, shuffle=True, drop_last=True)
